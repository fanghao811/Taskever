...
using Taskever.Dto;
using Taskever.Net.MimeTypes;
using OfficeOpenXml;

namespace Taskever.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : TaskeverServiceBase, ITransientDependency
    {
