...
namespace Taskever.WebApi
{
    ...
    /// </summary>
    [DependsOn(typeof(AbpWebApiModule), typeof(AbpWebApiODataModule), typeof(TaskeverApplicationModule))]
    public class TaskeverWebApiModule : AbpModule
    {
        ...
        public override void Initialize()
        {
            ...
            DynamicApiControllerBuilder
                .ForAll<IApplicationService>(typeof(TaskeverApplicationModule).Assembly, "app")
                .Build();
        ...
        private void ConfigureSwaggerUi()
        {
            Configuration.Modules.AbpWebApi().HttpConfiguration
                .EnableSwagger(c =>
                {
                    c.SingleApiVersion("v1", "Taskever.WebApi");
