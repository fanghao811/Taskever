...
using Taskever.Tests.TestDatas;
...
namespace Taskever.Tests
{
    ...
    /// Provides methods to easily work with <see cref="TaskeverDbContext"/>.
    /// </summary>
    public abstract class AppTestBase : AbpIntegratedTestBase
    {
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<TaskeverTestModule>();
        }

        #region UsingDbContext

        protected void UsingDbContext(Action<TaskeverDbContext> action)
        {
        ...
        protected async Task UsingDbContextAsync(Action<TaskeverDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<TaskeverDbContext>())
            {
                context.DisableAllFilters();
        ...
        protected T UsingDbContext<T>(Func<TaskeverDbContext, T> func)
        {
            T result;
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TaskeverDbContext, Task<T>> func)
        {
            T result;
